 ...
 * as an orchestrator that delegates rather than doing everything itself. It
 * asks for the `dispatch_worker` tool (the MCP path, Phase 4) but falls back
 * to Claude Code's own Task tool — so this works today with no backend change.
 */
